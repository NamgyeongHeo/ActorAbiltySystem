...
namespace ActorAbilitySystem.Editor
{
    public class AbilityBodyGenerator// : ICodeGenerator
    {
        ...
        {
            TypeCache.TypeCollection abilityTypeCollection = TypeCache.GetTypesDerivedFrom<ActorAbility>();
        ...
        private static CodeGenerationContext GetBodyGeneration(Type abilityType)
        {
            ...
            */
            codeBuilder.AppendLine($"public partial class {abilityName} : {nameof(ActorAbility)}");
            codeBuilder.AppendLine("{");
